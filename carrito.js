...
const actualizarTablaCarrito = () => {
    ...
    productosEnCarrito.forEach(producto => {
        ...
        <td class="p-4">
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a href="#" class="d-block text-dark nombre-producto">${producto.nombre}</a>
        ...
        $fila.find('.quantity-control button').on('click', (e) => {
            ...
            localStorage.setItem("productos-en-carrito", JSON.stringify(recuperarCarrito()));
...
// Llamar a la función cuando la página se carga para inicializar la tabla y el total
$(document).ready(() => {
